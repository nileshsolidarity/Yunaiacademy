...
Recognition criteria require that an item meets the definition of an element and that recognizing it provides relevant information that faithfully represents the item. Measurement bases include historical cost, current value (fair value, value in use, and current cost).`,
        ...
        questions: [
          ...
          { question: 'A machine purchased for Rs 5,00,000 with a useful life of 10 years and residual value of Rs 50,000 is depreciated under Straight Line Method. What is the annual depreciation?', options: ['Rs 50,000', 'Rs 45,000', 'Rs 55,000', 'Rs 40,000'], correctAnswer: 1, explanation: 'SLM Depreciation = (Cost - Residual Value) / Useful Life = (5,00,000 - 50,000) / 10 = Rs 45,000 per annum.' },
          { question: 'An entity sells goods worth Rs 10,00,000 on 25th March but delivery is scheduled for 5th April. As per the revenue recognition framework, when should revenue be recognized?', options: ['25th March when the sale agreement is signed', '5th April when delivery occurs and risks transfer', '1st April as the new financial year begins', 'Equally split between March and April'], correctAnswer: 1, explanation: 'Revenue is recognized when significant risks and rewards of ownership are transferred, which occurs on delivery (5th April).' },
          { question: 'If total assets are Rs 80 lakhs and total liabilities are Rs 55 lakhs, what is the equity as per the elements of financial statements?', options: ['Rs 135 lakhs', 'Rs 25 lakhs', 'Rs 55 lakhs', 'Rs 80 lakhs'], correctAnswer: 1, explanation: 'Equity = Assets - Liabilities = Rs 80 lakhs - Rs 55 lakhs = Rs 25 lakhs (residual interest in assets after deducting liabilities).' },
        ],
      },
      {
...
AS-19 deals with Leases. A finance lease transfers substantially all risks and rewards to the lessee. An operating lease does not transfer substantially all risks and rewards. Classification depends on substance rather than legal form of the transaction.`,
        ...
        questions: [
          ...
          { question: 'A machine costing Rs 2,00,000 is depreciated at 15% WDV under AS-10. What is the written down value at the end of Year 2?', options: ['Rs 1,44,500', 'Rs 1,70,000', 'Rs 1,40,000', 'Rs 1,50,000'], correctAnswer: 0, explanation: 'Year 1 WDV = 2,00,000 - (15% of 2,00,000) = 2,00,000 - 30,000 = 1,70,000. Year 2 WDV = 1,70,000 - (15% of 1,70,000) = 1,70,000 - 25,500 = Rs 1,44,500.' },
          { question: 'Under AS-9, a company provides consultancy services for Rs 6,00,000 over 3 months. By year-end, 2 months are completed. How much revenue should be recognized?', options: ['Rs 6,00,000', 'Rs 4,00,000', 'Rs 2,00,000', 'Nil until completion'], correctAnswer: 1, explanation: 'Under AS-9, service revenue is recognized proportionally. Revenue = Rs 6,00,000 x (2/3) = Rs 4,00,000.' },
          { question: 'An investment purchased for Rs 1,00,000 as a current investment has a fair value of Rs 85,000 at year-end. Under AS-13, at what value should it be carried?', options: ['Rs 1,00,000', 'Rs 85,000', 'Rs 92,500', 'Rs 15,000'], correctAnswer: 1, explanation: 'Under AS-13, current investments are carried at lower of cost (Rs 1,00,000) and fair value (Rs 85,000) = Rs 85,000.' },
        ],
      },
      {
...
Debentures are debt instruments issued by companies. They may be secured or unsecured, convertible or non-convertible. Interest on debentures is a charge against profits. Redemption of debentures can be at par, premium, or through sinking fund.`,
        ...
        questions: [
          ...
          { question: 'A company issues 10,000 shares of Rs 10 each at a premium of Rs 5. What is the total amount credited to Securities Premium Account?', options: ['Rs 50,000', 'Rs 1,00,000', 'Rs 1,50,000', 'Rs 10,000'], correctAnswer: 0, explanation: 'Securities Premium = Number of shares x Premium per share = 10,000 x Rs 5 = Rs 50,000.' },
          { question: 'A company redeems 5,000 preference shares of Rs 100 each out of profits. What amount is transferred to Capital Redemption Reserve?', options: ['Rs 2,50,000', 'Rs 5,00,000', 'Rs 1,00,000', 'Rs 50,000'], correctAnswer: 1, explanation: 'When redeemed out of profits, CRR = Nominal value of shares redeemed = 5,000 x Rs 100 = Rs 5,00,000.' },
          { question: 'A company has paid-up capital of Rs 40 lakhs and free reserves of Rs 60 lakhs. What is the maximum amount of buy-back allowed?', options: ['Rs 10 lakhs', 'Rs 15 lakhs', 'Rs 25 lakhs', 'Rs 50 lakhs'], correctAnswer: 2, explanation: 'Maximum buy-back = 25% of (Paid-up capital + Free reserves) = 25% of (40 + 60) = 25% of Rs 100 lakhs = Rs 25 lakhs.' },
        ],
      },
      {
...
Internal Reconstruction involves reorganizing the financial structure of a company without forming a new company. It typically involves reduction of share capital, writing off losses, and revaluing assets. This requires court approval and compliance with the Companies Act provisions.`,
        ...
        questions: [
          ...
          { question: 'In an amalgamation (purchase method), the transferee company pays Rs 12,00,000 as purchase consideration. Net assets acquired at fair value are Rs 10,00,000. What is the goodwill?', options: ['Rs 10,00,000', 'Rs 2,00,000', 'Rs 12,00,000', 'Rs 22,00,000'], correctAnswer: 1, explanation: 'Goodwill = Purchase Consideration - Net Assets at fair value = Rs 12,00,000 - Rs 10,00,000 = Rs 2,00,000.' },
          { question: 'In a merger-type amalgamation, transferor company has share capital of Rs 5,00,000 and reserves of Rs 3,00,000. Transferee issues shares worth Rs 5,00,000. What is the adjustment to reserves?', options: ['Rs 3,00,000 credited to reserves', 'Rs 3,00,000 debited to reserves', 'Rs 8,00,000 credited to reserves', 'No adjustment needed'], correctAnswer: 0, explanation: 'Under pooling of interests, difference between share capital issued (Rs 5,00,000) and transferor share capital (Rs 5,00,000) is zero. Transferor reserves of Rs 3,00,000 are carried forward to transferee reserves.' },
          { question: 'Company A acquires Company B. Purchase consideration is Rs 8,00,000 and fair value of net assets of B is Rs 9,50,000. What arises on amalgamation?', options: ['Goodwill of Rs 1,50,000', 'Capital Reserve of Rs 1,50,000', 'Revenue Reserve of Rs 1,50,000', 'No difference'], correctAnswer: 1, explanation: 'When net assets (Rs 9,50,000) exceed purchase consideration (Rs 8,00,000), the difference of Rs 1,50,000 is Capital Reserve.' },
        ],
      },
      {
...
Intra-group transactions (sales between parent and subsidiary) must be eliminated to avoid double counting. This includes intra-group sales, unrealized profits on inventory, intra-group loans, and dividends. Only transactions with external parties are reflected in consolidated statements.`,
        ...
        questions: [
          ...
          { question: 'Parent holds 80% of subsidiary with net assets of Rs 10,00,000 at acquisition date. Cost of investment is Rs 9,00,000. What is the goodwill on consolidation?', options: ['Rs 1,00,000', 'Rs 9,00,000', 'Rs 2,00,000', 'Nil'], correctAnswer: 0, explanation: 'Parent share of net assets = 80% x Rs 10,00,000 = Rs 8,00,000. Goodwill = Cost of investment (Rs 9,00,000) - Parent share (Rs 8,00,000) = Rs 1,00,000.' },
          { question: 'A subsidiary has net assets of Rs 20,00,000. Parent holds 75%. What is the Minority Interest?', options: ['Rs 15,00,000', 'Rs 5,00,000', 'Rs 20,00,000', 'Rs 10,00,000'], correctAnswer: 1, explanation: 'Minority Interest = (100% - 75%) x Rs 20,00,000 = 25% x Rs 20,00,000 = Rs 5,00,000.' },
          { question: 'Parent sold goods to subsidiary for Rs 3,00,000 (cost Rs 2,40,000). Subsidiary still holds Rs 1,00,000 of these goods in closing stock. What is the unrealized profit to be eliminated?', options: ['Rs 60,000', 'Rs 20,000', 'Rs 40,000', 'Rs 1,00,000'], correctAnswer: 1, explanation: 'Profit margin = (3,00,000 - 2,40,000) / 3,00,000 = 60,000/3,00,000 = 20%. Unrealized profit on closing stock = 20% x Rs 1,00,000 = Rs 20,000.' },
        ],
      },
    ],
  },
...
Key managerial personnel include Managing Director, Whole-time Director, CEO, CFO, and Company Secretary. Their appointment, remuneration, and removal are governed by specific provisions of the Companies Act.`,
        ...
        questions: [
          ...
          { question: 'A group of 5 individuals wants to form a company with freely transferable shares and no restriction on maximum members. Which type of company should they incorporate?', options: ['Private Company', 'One Person Company', 'Public Company', 'Section 8 Company'], correctAnswer: 2, explanation: 'A Public Company allows freely transferable shares and has no maximum member limit. It requires a minimum of 7 members, so they would need 2 more.' },
          { question: 'Mr. X is appointed as the first director of a newly incorporated private company. The Board must appoint the first auditor within:', options: ['15 days of incorporation', '30 days of incorporation', '60 days of incorporation', '90 days of incorporation'], correctAnswer: 1, explanation: 'Under Section 139(6) of the Companies Act, the first auditor must be appointed by the Board within 30 days of incorporation.' },
          { question: 'ABC Ltd. is a listed public company. What is the minimum number of independent directors it must have on its Board?', options: ['No independent directors required', 'At least one-fourth of total directors', 'At least one-third of total directors', 'At least half of total directors'], correctAnswer: 2, explanation: 'Listed public companies must have at least one-third of the total number of directors as independent directors under the Companies Act, 2013.' },
        ],
      },
      {
...
Proxy is a person authorized by a member to attend and vote at a meeting on their behalf. Every member entitled to attend and vote can appoint a proxy. A proxy cannot speak at the meeting. Section 105 governs proxy provisions.`,
        ...
        questions: [
          ...
          { question: 'PQR Ltd. wants to change its registered name. What type of resolution is required?', options: ['Ordinary resolution', 'Special resolution', 'Board resolution only', 'No resolution needed'], correctAnswer: 1, explanation: 'Change of company name requires a special resolution (at least 75% of votes cast) under the Companies Act, 2013.' },
          { question: 'A public company has 3,500 members. What is the quorum for its general meeting?', options: ['5 members', '15 members', '30 members', '35 members'], correctAnswer: 1, explanation: 'For public companies with 1,001 to 5,000 members, the quorum is 15 members personally present.' },
          { question: 'The Board of XYZ Ltd. has 9 directors. What is the minimum quorum for a Board meeting?', options: ['2 directors', '3 directors', '4 directors', '5 directors'], correctAnswer: 1, explanation: 'Board meeting quorum = one-third of total strength or 2, whichever is higher. One-third of 9 = 3. Since 3 > 2, quorum is 3 directors.' },
        ],
      },
      {
...
During winding up, a liquidator is appointed to collect assets, settle liabilities, and distribute surplus among members. The order of payment is: secured creditors, winding up costs, preferential creditors (employees, government dues), unsecured creditors, and finally shareholders.`,
        ...
        questions: [
          ...
          { question: 'During winding up of ABC Ltd., the liquidator collects Rs 50,00,000 in assets. Secured creditors are owed Rs 20,00,000, winding up costs are Rs 5,00,000, preferential creditors Rs 10,00,000, and unsecured creditors Rs 25,00,000. How much do unsecured creditors receive?', options: ['Rs 25,00,000', 'Rs 15,00,000', 'Rs 10,00,000', 'Rs 20,00,000'], correctAnswer: 1, explanation: 'Available after secured creditors (Rs 20L) and winding up costs (Rs 5L) and preferential creditors (Rs 10L) = Rs 50L - Rs 35L = Rs 15,00,000 for unsecured creditors.' },
          { question: 'A company has been conducting affairs in a fraudulent manner. Which ground for compulsory winding up by NCLT does this fall under?', options: ['Just and equitable ground', 'Fraudulent conduct of affairs', 'Non-filing of returns', 'Special resolution by members'], correctAnswer: 1, explanation: 'NCLT can order compulsory winding up when the company affairs have been conducted in a fraudulent manner as a specific ground under the Companies Act.' },
          { question: 'An aggrieved party wants to challenge an NCLAT order. To which court can they appeal and on what basis?', options: ['High Court on facts and law', 'Supreme Court on questions of law only', 'District Court on any matter', 'No further appeal is possible'], correctAnswer: 1, explanation: 'Further appeals from NCLAT orders lie to the Supreme Court, but only on questions of law.' },
        ],
      },
      {
...
Abuse of dominant position includes imposing unfair conditions, limiting production, denying market access, and applying discriminatory conditions. Mergers and acquisitions beyond specified thresholds require mandatory notification to CCI for prior approval.`,
        ...
        questions: [
          ...
          { question: 'A company formed as an LLP has 3 partners. One partner wants limited liability while participating in management. Compared to a private company, which statement is true about LLPs?', options: ['LLP partners cannot participate in management', 'LLP provides limited liability to all partners including managing partners', 'LLP requires minimum 7 partners', 'LLP must have a Board of Directors'], correctAnswer: 1, explanation: 'In an LLP, all partners enjoy limited liability (liability limited to their agreed contribution) while being able to participate in management, unlike a general partnership.' },
          { question: 'Company Z violates FEMA provisions by making unauthorized capital account transactions. What type of penalty applies?', options: ['Criminal prosecution and imprisonment', 'Civil penalty (monetary fine) only', 'Both criminal and civil penalties', 'No penalty, only a warning'], correctAnswer: 1, explanation: 'Under FEMA, contraventions attract civil penalties (monetary fines), not criminal prosecution. This is a key difference from the earlier FERA which had criminal provisions.' },
          { question: 'Two competing pharmaceutical companies agree to divide the Indian market geographically so that each operates exclusively in certain states. Under the Competition Act, this is an example of:', options: ['Legitimate business strategy', 'Market sharing (anti-competitive agreement)', 'Abuse of dominant position', 'A valid merger arrangement'], correctAnswer: 1, explanation: 'Market sharing agreements between competitors are specifically listed as anti-competitive agreements under the Competition Act, 2002. Such horizontal agreements are presumed to have appreciable adverse effect on competition.' },
        ],
      },
    ],
  },
...
Tax liability includes income tax, surcharge (if applicable), and health and education cess at 4%. Advance tax must be paid in installments during the year. TDS (Tax Deducted at Source) is deducted by the payer on specified payments.`,
        ...
        questions: [
          ...
          { question: 'Mr. A has salary income of Rs 6,00,000, house property income of Rs 1,50,000, and bank interest of Rs 30,000. What is his Gross Total Income?', options: ['Rs 7,80,000', 'Rs 6,00,000', 'Rs 7,50,000', 'Rs 6,30,000'], correctAnswer: 0, explanation: 'Gross Total Income = Income from all heads = Rs 6,00,000 + Rs 1,50,000 + Rs 30,000 = Rs 7,80,000.' },
          { question: 'An individual has a total income of Rs 10,00,000. The income tax computed is Rs 1,12,500. What is the total tax liability including Health & Education Cess?', options: ['Rs 1,12,500', 'Rs 1,17,000', 'Rs 1,16,500', 'Rs 1,20,000'], correctAnswer: 1, explanation: 'Total tax liability = Income Tax + 4% Cess = Rs 1,12,500 + (4% of Rs 1,12,500) = Rs 1,12,500 + Rs 4,500 = Rs 1,17,000.' },
          { question: 'Mr. B, a Non-Resident Indian, earns Rs 5,00,000 in India and Rs 8,00,000 abroad. What is his taxable income in India?', options: ['Rs 13,00,000', 'Rs 5,00,000', 'Rs 8,00,000', 'Nil'], correctAnswer: 1, explanation: 'A Non-Resident is taxed only on income earned or received in India. Taxable income = Rs 5,00,000 (Indian income only).' },
        ],
      },
      {
...
For self-occupied property, the annual value is considered nil. Interest deduction is limited to Rs 2 lakhs for self-occupied property (Section 24(b)). For let-out property, there is no limit on interest deduction. Loss from house property can be set off against other income up to Rs 2 lakhs.`,
        ...
        questions: [
          ...
          { question: 'Mr. X receives a basic salary of Rs 30,000/month and HRA of Rs 15,000/month. He pays rent of Rs 12,000/month in Delhi (metro city). His exempt HRA under Section 10(13A) is:', options: ['Rs 1,80,000', 'Rs 1,44,000', 'Rs 1,08,000', 'Rs 36,000'], correctAnswer: 2, explanation: 'HRA exemption is the least of: (a) Actual HRA = Rs 1,80,000, (b) 50% of salary (metro) = Rs 1,80,000, (c) Rent paid - 10% of salary = Rs 1,44,000 - Rs 36,000 = Rs 1,08,000. Least is Rs 1,08,000.' },
          { question: 'A let-out property has Gross Annual Value of Rs 4,00,000 and municipal taxes paid of Rs 40,000. What is the income from house property (ignoring interest on loan)?', options: ['Rs 4,00,000', 'Rs 2,52,000', 'Rs 2,80,000', 'Rs 3,60,000'], correctAnswer: 1, explanation: 'Net Annual Value = GAV - Municipal taxes = 4,00,000 - 40,000 = Rs 3,60,000. Income = NAV - 30% standard deduction = 3,60,000 - 1,08,000 = Rs 2,52,000.' },
          { question: 'An employee receives basic salary of Rs 50,000/month. His employer contributes 15% of salary to recognized provident fund. What is the taxable employer PF contribution?', options: ['Rs 90,000 per annum', 'Rs 18,000 per annum', 'Nil', 'Rs 7,500 per month'], correctAnswer: 1, explanation: 'Employer PF contribution up to 12% of salary is exempt. Excess = 15% - 12% = 3% of Rs 50,000 = Rs 1,500/month = Rs 18,000 per annum is taxable.' },
        ],
      },
      {
...
Exemptions from capital gains include: Section 54 (investment in residential house from sale of residential property), Section 54EC (investment in specified bonds within 6 months), and Section 54F (investment in residential house from sale of any long-term capital asset other than house property).`,
        ...
        questions: [
          ...
          { question: 'A block of plant and machinery has WDV of Rs 10,00,000 on 1st April. A new machine costing Rs 4,00,000 is purchased on 15th October for a manufacturing unit. What is the total depreciation at 15% (including additional depreciation)?', options: ['Rs 2,10,000', 'Rs 2,50,000', 'Rs 2,90,000', 'Rs 1,70,000'], correctAnswer: 2, explanation: 'Normal depreciation = 15% of (10,00,000 + 4,00,000) = 15% of 14,00,000 = Rs 2,10,000. Additional depreciation = 20% of Rs 4,00,000 = Rs 80,000. Total = Rs 2,10,000 + Rs 80,000 = Rs 2,90,000.' },
          { question: 'Mr. Y purchased a house in April 2015 for Rs 30,00,000 (CII: 254) and sold it in March 2024 for Rs 75,00,000 (CII: 363). What is the indexed cost of acquisition?', options: ['Rs 42,87,402', 'Rs 30,00,000', 'Rs 75,00,000', 'Rs 45,00,000'], correctAnswer: 0, explanation: 'Indexed Cost = Cost x (CII of sale year / CII of purchase year) = 30,00,000 x (363/254) = 30,00,000 x 1.42913 = Rs 42,87,402 (approx).' },
          { question: 'A trader has gross receipts of Rs 85,00,000, purchases of Rs 50,00,000, and allowable expenses of Rs 15,00,000. Income tax paid during the year is Rs 3,00,000. What is his business income?', options: ['Rs 20,00,000', 'Rs 17,00,000', 'Rs 35,00,000', 'Rs 23,00,000'], correctAnswer: 0, explanation: 'Business Income = Gross receipts - Purchases - Allowable expenses = 85,00,000 - 50,00,000 - 15,00,000 = Rs 20,00,000. Income tax paid (Rs 3,00,000) is disallowed and not deductible.' },
        ],
      },
      {
...
Set-off and carry forward of losses: Intra-head set-off happens first, then inter-head set-off. Business loss can be set off against any income except salary. Unabsorbed business loss carries forward for 8 years. Capital loss can only be set off against capital gains.`,
        ...
        questions: [
          ...
          { question: 'Mr. P invests Rs 1,50,000 in PPF, Rs 40,000 in ELSS, and pays Rs 25,000 for medical insurance for self. What is his total deduction under Sections 80C and 80D?', options: ['Rs 2,15,000', 'Rs 1,75,000', 'Rs 1,90,000', 'Rs 1,50,000'], correctAnswer: 1, explanation: 'Section 80C: Maximum Rs 1,50,000 (PPF Rs 1,50,000 + ELSS Rs 40,000 = Rs 1,90,000, capped at Rs 1,50,000). Section 80D: Rs 25,000. Total = Rs 1,50,000 + Rs 25,000 = Rs 1,75,000.' },
          { question: 'A senior citizen (age 65) has total income of Rs 5,50,000 (old regime). The tax on income between Rs 3,00,000 and Rs 5,00,000 at 5%, and Rs 5,00,000 to Rs 5,50,000 at 20%. What is the income tax before cess?', options: ['Rs 10,000', 'Rs 20,000', 'Rs 15,000', 'Rs 30,000'], correctAnswer: 1, explanation: 'Senior citizen exemption is Rs 3,00,000. Tax = 5% of (5,00,000 - 3,00,000) + 20% of (5,50,000 - 5,00,000) = 5% of 2,00,000 + 20% of 50,000 = Rs 10,000 + Rs 10,000 = Rs 20,000.' },
          { question: 'Mr. Q has business loss of Rs 3,00,000 and income from house property of Rs 5,00,000. What is his Gross Total Income after inter-head set-off?', options: ['Rs 8,00,000', 'Rs 5,00,000', 'Rs 2,00,000', 'Rs 3,00,000'], correctAnswer: 2, explanation: 'Business loss can be set off against any income except salary. After set-off: Rs 5,00,000 - Rs 3,00,000 = Rs 2,00,000.' },
        ],
      },
      {
...
Key compliance requirements include: Monthly returns (GSTR-1 for outward supplies, GSTR-3B for summary), Annual return (GSTR-9), and GST Audit for turnover exceeding Rs 5 crores. E-way bills are required for movement of goods exceeding Rs 50,000 in value.`,
        ...
        questions: [
          ...
          { question: 'A dealer in Mumbai sells goods worth Rs 2,00,000 (exclusive of GST at 18%) to a buyer in Mumbai. What are the CGST and SGST amounts?', options: ['CGST Rs 36,000 and SGST Nil', 'CGST Rs 18,000 and SGST Rs 18,000', 'IGST Rs 36,000', 'CGST Rs 9,000 and SGST Rs 9,000'], correctAnswer: 1, explanation: 'Intra-state supply (both in Mumbai/Maharashtra): GST 18% = Rs 36,000 split equally as CGST 9% = Rs 18,000 and SGST 9% = Rs 18,000.' },
          { question: 'A manufacturer purchases raw materials for Rs 5,00,000 plus GST of Rs 90,000. He sells finished goods for Rs 8,00,000 plus GST of Rs 1,44,000. What is his GST payable (net of ITC)?', options: ['Rs 1,44,000', 'Rs 54,000', 'Rs 90,000', 'Rs 2,34,000'], correctAnswer: 1, explanation: 'GST payable = Output GST - Input Tax Credit = Rs 1,44,000 - Rs 90,000 = Rs 54,000.' },
          { question: 'A supplier in Delhi sells goods to a buyer in Rajasthan at Rs 1,00,000 plus 12% GST. Which tax component applies and what is the amount?', options: ['CGST Rs 6,000 + SGST Rs 6,000', 'IGST Rs 12,000', 'CGST Rs 12,000 only', 'SGST Rs 12,000 only'], correctAnswer: 1, explanation: 'Inter-state supply (Delhi to Rajasthan) attracts IGST. IGST = 12% of Rs 1,00,000 = Rs 12,000.' },
        ],
      },
    ],
  },
...
The total cost of a product comprises: Prime Cost (Direct Material + Direct Labour + Direct Expenses) + Factory Overheads = Works Cost + Office Overheads = Cost of Production + Selling and Distribution Overheads = Total Cost/Cost of Sales.`,
        ...
        questions: [
          ...
          { question: 'A product has Direct Material Rs 50, Direct Labour Rs 30, Direct Expenses Rs 10, Factory Overhead Rs 25, Office Overhead Rs 15, and Selling Overhead Rs 20. What is the Works Cost per unit?', options: ['Rs 90', 'Rs 115', 'Rs 130', 'Rs 150'], correctAnswer: 1, explanation: 'Prime Cost = 50 + 30 + 10 = Rs 90. Works Cost = Prime Cost + Factory Overhead = 90 + 25 = Rs 115.' },
          { question: 'A factory produces 10,000 units. Fixed costs are Rs 2,00,000 and variable cost per unit is Rs 15. What is the total cost per unit?', options: ['Rs 15', 'Rs 20', 'Rs 35', 'Rs 25'], correctAnswer: 2, explanation: 'Fixed cost per unit = Rs 2,00,000 / 10,000 = Rs 20. Total cost per unit = Fixed cost per unit + Variable cost per unit = Rs 20 + Rs 15 = Rs 35.' },
          { question: 'Company X can either manufacture a component at Rs 80 per unit or buy it at Rs 70. If manufacturing is chosen, the next best alternative is buying, which would save Rs 10 per unit. What is the opportunity cost of manufacturing?', options: ['Rs 80', 'Rs 70', 'Rs 10', 'Rs 150'], correctAnswer: 2, explanation: 'Opportunity cost = Benefit foregone from next best alternative = Saving from buying (Rs 80 - Rs 70) = Rs 10 per unit.' },
        ],
      },
      {
...
Labour turnover refers to the rate at which employees leave and are replaced. It is measured as: (Number of separations / Average number of workers) x 100. High turnover increases costs through recruitment, training, and reduced productivity. Preventive measures include good working conditions and fair wages.`,
        ...
        questions: [
          ...
          { question: 'Annual demand is 10,000 units, ordering cost is Rs 200 per order, and carrying cost is Rs 10 per unit per annum. What is the EOQ?', options: ['200 units', '400 units', '632 units', '1,000 units'], correctAnswer: 2, explanation: 'EOQ = sqrt(2DS/H) = sqrt(2 x 10,000 x 200 / 10) = sqrt(4,00,000) = 632.45, approximately 632 units.' },
          { question: 'Standard time for a job is 10 hours and hourly rate is Rs 50. A worker completes it in 8 hours. Under the Halsey Plan, what is his total earnings?', options: ['Rs 400', 'Rs 450', 'Rs 500', 'Rs 550'], correctAnswer: 1, explanation: 'Time saved = 10 - 8 = 2 hours. Bonus = 50% x 2 hours x Rs 50 = Rs 50. Total earnings = (8 x Rs 50) + Rs 50 = Rs 400 + Rs 50 = Rs 450.' },
          { question: 'A factory started with 500 workers, 50 left during the year, 30 were discharged, and 60 were recruited. What is the labour turnover rate using the separation method?', options: ['16%', '10%', '15.09%', '6%'], correctAnswer: 0, explanation: 'Separations = 50 + 30 = 80. Average workers = (500 + 500 - 80 + 60) / 2 = 980/2 = 490. Labour turnover = (80/490) x 100 is approximately 16.33%. Alternatively, using beginning count: (80/500) x 100 = 16%.' },
        ],
      },
      {
...
Under-absorption occurs when actual overheads exceed absorbed overheads. Over-absorption occurs when absorbed overheads exceed actual overheads. The difference is treated by: supplementary rate, writing off to costing P&L, or carrying forward.`,
        ...
        questions: [
          ...
          { question: 'A factory has budgeted overheads of Rs 6,00,000 and budgeted machine hours of 30,000. Actual overheads are Rs 6,50,000 and actual machine hours are 32,000. What is the over- or under-absorption?', options: ['Under-absorption of Rs 10,000', 'Over-absorption of Rs 10,000', 'Under-absorption of Rs 50,000', 'Over-absorption of Rs 50,000'], correctAnswer: 0, explanation: 'Absorption rate = Rs 6,00,000 / 30,000 = Rs 20 per hour. Absorbed = 32,000 x Rs 20 = Rs 6,40,000. Actual = Rs 6,50,000. Under-absorbed = Rs 6,50,000 - Rs 6,40,000 = Rs 10,000.' },
          { question: 'Department A occupies 4,000 sq ft and Department B occupies 6,000 sq ft. Total rent is Rs 50,000. How much rent is apportioned to Department B?', options: ['Rs 20,000', 'Rs 25,000', 'Rs 30,000', 'Rs 50,000'], correctAnswer: 2, explanation: 'Rent apportioned to B = (6,000 / 10,000) x Rs 50,000 = 60% x Rs 50,000 = Rs 30,000.' },
          { question: 'Budgeted direct labour hours are 20,000 and budgeted production overhead is Rs 3,00,000. A job takes 50 direct labour hours. What overhead is absorbed by this job?', options: ['Rs 500', 'Rs 750', 'Rs 1,000', 'Rs 1,500'], correctAnswer: 1, explanation: 'Direct Labour Hour Rate = Rs 3,00,000 / 20,000 = Rs 15 per hour. Overhead absorbed = 50 x Rs 15 = Rs 750.' },
        ],
      },
      {
...
Key variances include: Material Cost Variance (Price + Usage), Labour Cost Variance (Rate + Efficiency), Variable Overhead Variance (Expenditure + Efficiency), and Fixed Overhead Variance (Expenditure + Volume). Favorable variances reduce costs, while adverse variances increase costs.`,
        ...
        questions: [
          ...
          { question: 'Standard price of material is Rs 5 per kg and standard quantity for actual output is 2,000 kg. Actual quantity used is 2,200 kg at Rs 4.50 per kg. What is the Material Usage Variance?', options: ['Rs 1,000 Adverse', 'Rs 1,000 Favorable', 'Rs 1,100 Adverse', 'Rs 900 Adverse'], correctAnswer: 0, explanation: 'Material Usage Variance = Standard Price x (Standard Qty - Actual Qty) = Rs 5 x (2,000 - 2,200) = Rs 5 x (-200) = Rs 1,000 Adverse.' },
          { question: 'In a process, 1,000 units are introduced. Normal loss is 10%. Actual output is 870 units. Process cost is Rs 1,00,000 and scrap value is Rs 5 per unit. What is the abnormal loss in units?', options: ['30 units', '100 units', '130 units', '0 units'], correctAnswer: 0, explanation: 'Normal loss = 10% of 1,000 = 100 units. Expected output = 1,000 - 100 = 900 units. Abnormal loss = Expected output - Actual output = 900 - 870 = 30 units.' },
          { question: 'Standard labour rate is Rs 20 per hour and standard hours for actual production are 500. Actual hours worked are 520 at Rs 22 per hour. What is the Labour Rate Variance?', options: ['Rs 1,040 Adverse', 'Rs 400 Adverse', 'Rs 1,000 Adverse', 'Rs 1,040 Favorable'], correctAnswer: 0, explanation: 'Labour Rate Variance = Actual Hours x (Standard Rate - Actual Rate) = 520 x (20 - 22) = 520 x (-2) = Rs 1,040 Adverse.' },
        ],
      },
      {
...
Flexible budgets adjust for different activity levels, unlike fixed budgets prepared for a single level. Budget variance = Actual results - Budgeted results. Zero-based budgeting requires justification of all expenditures from scratch each period, not just incremental changes.`,
        ...
        questions: [
          ...
          { question: 'A product sells at Rs 100 per unit. Variable cost is Rs 60 per unit and total fixed costs are Rs 2,00,000. What is the break-even point in units?', options: ['2,000 units', '3,333 units', '5,000 units', '4,000 units'], correctAnswer: 2, explanation: 'Contribution per unit = Rs 100 - Rs 60 = Rs 40. BEP in units = Fixed Costs / Contribution per unit = Rs 2,00,000 / Rs 40 = 5,000 units.' },
          { question: 'Sales are Rs 10,00,000 and variable costs are Rs 6,00,000. What is the P/V Ratio?', options: ['60%', '40%', '166.67%', '25%'], correctAnswer: 1, explanation: 'Contribution = Rs 10,00,000 - Rs 6,00,000 = Rs 4,00,000. P/V Ratio = (Contribution / Sales) x 100 = (4,00,000 / 10,00,000) x 100 = 40%.' },
          { question: 'Fixed costs are Rs 3,00,000 and P/V Ratio is 30%. What is the break-even sales value?', options: ['Rs 9,00,000', 'Rs 10,00,000', 'Rs 1,00,000', 'Rs 90,000'], correctAnswer: 1, explanation: 'BEP in value = Fixed Costs / P/V Ratio = Rs 3,00,000 / 0.30 = Rs 10,00,000.' },
        ],
      },
    ],
  },
...
Materiality is the magnitude of an omission or misstatement that could influence the economic decisions of users. The auditor determines materiality for the financial statements as a whole and may determine a lower materiality level for specific classes of transactions or account balances.`,
        ...
        questions: [
          ...
          { question: 'An auditor assesses inherent risk at 80% and control risk at 50%. To achieve an overall audit risk of 4%, what is the maximum acceptable detection risk?', options: ['10%', '5%', '20%', '40%'], correctAnswer: 0, explanation: 'Audit Risk = IR x CR x DR. So DR = AR / (IR x CR) = 0.04 / (0.80 x 0.50) = 0.04 / 0.40 = 0.10 = 10%.' },
          { question: 'During an audit of a manufacturing company, the auditor discovers that inventory represents 60% of total assets and involves complex valuation. This scenario represents which type of risk?', options: ['Detection risk', 'Control risk', 'Inherent risk', 'Sampling risk'], correctAnswer: 2, explanation: 'Inherent risk relates to the susceptibility of an assertion to misstatement before considering controls. Complex inventory valuation and high materiality to financial statements create high inherent risk.' },
          { question: 'A company has revenue of Rs 50 crores. The auditor sets materiality at 1% of revenue. Any misstatement above what amount would be considered material?', options: ['Rs 5 lakhs', 'Rs 50 lakhs', 'Rs 5 crores', 'Rs 50 crores'], correctAnswer: 1, explanation: 'Materiality = 1% of Rs 50 crores = Rs 50,00,000 = Rs 50 lakhs. Misstatements above this amount would be considered material.' },
        ],
      },
      {
...
Engagement letters establish the terms of the audit engagement between the auditor and the client. They specify the objective and scope of audit, responsibilities of the auditor and management, applicable financial reporting framework, and the expected form of reports.`,
        ...
        questions: [
          ...
          { question: 'An auditor observes that a company\'s gross profit margin has dropped from 35% to 20% without any known change in business conditions. Which audit procedure identified this anomaly?', options: ['Inspection of records', 'External confirmation', 'Analytical procedures', 'Recalculation'], correctAnswer: 2, explanation: 'Analytical procedures involve evaluating financial information through analysis of plausible relationships. Comparing gross profit margins across periods is a common analytical procedure to identify unusual trends.' },
          { question: 'During planning, the auditor discovers the client recently changed its accounting software and several new staff members handle accounts. What is the most appropriate response?', options: ['Withdraw from the engagement', 'Increase reliance on internal controls', 'Assess higher risk and plan more substantive procedures', 'Reduce the audit scope'], correctAnswer: 2, explanation: 'New systems and inexperienced staff increase the risk of misstatement. The auditor should assess a higher risk level and design more extensive substantive procedures to respond appropriately.' },
          { question: 'An auditor finds that the client\'s internal control over cash receipts is strong but the control over journal entries is weak. How should the auditor design further procedures?', options: ['Rely on controls for both areas', 'Perform tests of controls for cash and substantive procedures for journal entries', 'Perform only substantive procedures for both', 'Ignore the weak area'], correctAnswer: 1, explanation: 'Where controls are strong (cash receipts), the auditor can rely on tests of controls. Where controls are weak (journal entries), more substantive procedures are needed to detect misstatements.' },
        ],
      },
      {
...
Assertions are representations by management embodied in financial statements. They relate to: Existence/Occurrence, Completeness, Rights and Obligations, Valuation/Allocation, and Presentation and Disclosure. The auditor designs procedures to test each relevant assertion.`,
        ...
        questions: [
          ...
          { question: 'An auditor wants to verify that a debtor balance of Rs 5,00,000 actually exists. He sends a letter to the debtor asking them to confirm the balance directly to the auditor. This is an example of:', options: ['Vouching', 'Verification', 'External confirmation', 'Inspection'], correctAnswer: 2, explanation: 'External confirmation involves obtaining a direct written response from a third party (the debtor) to verify the existence and accuracy of the balance. This is a positive confirmation request.' },
          { question: 'An auditor checks whether a payment voucher is supported by an invoice, goods receipt note, and proper authorization. This procedure is called:', options: ['Verification', 'Vouching', 'Confirmation', 'Analytical procedure'], correctAnswer: 1, explanation: 'Vouching is the examination of documentary evidence (vouchers) supporting recorded transactions. It traces entries back to their source documents to verify occurrence and authorization.' },
          { question: 'The auditor physically inspects a piece of machinery listed in the fixed asset register and also verifies ownership through title documents. What is this procedure called?', options: ['Vouching only', 'Verification', 'Observation only', 'Inquiry'], correctAnswer: 1, explanation: 'Verification involves substantiating the existence, ownership, valuation, and proper disclosure of assets. It goes beyond vouching by checking physical existence and ownership documents.' },
        ],
      },
      {
...
CARO (Companies Auditor's Report Order) requires auditors to report on specific matters including fixed assets, inventory, loans granted, deposits, statutory dues, loan defaults, fraud, and related party transactions. CARO applies to companies other than banking, insurance, and Section 8 companies.`,
        ...
        questions: [
          ...
          { question: 'During the audit of XYZ Ltd., the auditor finds that inventory worth Rs 2 crores (out of total assets of Rs 50 crores) has been overstated. The misstatement is material but limited to inventory. What type of audit report should be issued?', options: ['Unmodified opinion', 'Qualified opinion', 'Adverse opinion', 'Disclaimer of opinion'], correctAnswer: 1, explanation: 'The misstatement is material (Rs 2 crores on Rs 50 crores is significant) but not pervasive (limited to inventory only). A qualified opinion is appropriate for material but not pervasive misstatements.' },
          { question: 'An auditor is unable to attend the physical inventory count and cannot apply alternative procedures. Inventory is 40% of total assets. What opinion should be issued?', options: ['Unmodified opinion', 'Qualified opinion', 'Adverse opinion', 'Disclaimer of opinion'], correctAnswer: 3, explanation: 'Inability to obtain sufficient appropriate evidence for a pervasive item (40% of total assets) warrants a disclaimer of opinion. The auditor cannot form an opinion due to the scope limitation.' },
          { question: 'An audit firm has been auditing ABC Ltd. for 9 consecutive years. Under the Companies Act rotation requirements, for how many more years can this firm continue?', options: ['1 more year', '5 more years', 'Must be rotated immediately', '6 more years'], correctAnswer: 0, explanation: 'An audit firm can serve for a maximum of 10 consecutive years (two terms of 5 years). After 9 years, only 1 more year is permissible before mandatory rotation.' },
        ],
      },
      {
...
Disciplinary mechanisms under the CA Act include proceedings before the Board of Discipline and the Disciplinary Committee. Misconduct includes professional misconduct (First Schedule) and other misconduct (Second Schedule). Penalties range from reprimand to removal of name from the register.`,
        ...
        questions: [
          ...
          { question: 'A CA firm is appointed as statutory auditor of Company X. The managing partner of the firm holds 100 shares in Company X. Which ethical threat does this represent?', options: ['Advocacy threat', 'Familiarity threat', 'Self-interest threat', 'Intimidation threat'], correctAnswer: 2, explanation: 'Holding financial interest (shares) in an audit client creates a self-interest threat, as the auditor may be biased in favor of the client to protect their investment.' },
          { question: 'CA Mr. A has been the engagement partner for the audit of DEF Ltd. for the past 6 years. The CFO of DEF Ltd. is his close friend from college. What should Mr. A do?', options: ['Continue the audit as friendship does not matter', 'Disclose the friendship and apply safeguards or withdraw', 'Only disclose if someone asks', 'Ignore as it is a personal matter'], correctAnswer: 1, explanation: 'Close personal relationship with client management creates a familiarity threat. The ethical response is to disclose the relationship, evaluate the threat, apply safeguards (like removing the partner), or withdraw if safeguards are inadequate.' },
          { question: 'During an audit, the client CEO threatens to replace the auditor unless a clean report is issued despite known misstatements. This is an example of:', options: ['Self-interest threat', 'Self-review threat', 'Intimidation threat', 'Advocacy threat'], correctAnswer: 2, explanation: 'Intimidation threat arises when the auditor is deterred from acting objectively due to actual or perceived pressures. Threatening to replace the auditor to influence the audit opinion is a clear intimidation threat.' },
        ],
      },
    ],
  },
...
The financial manager must balance profitability (return on investment) with liquidity (ability to meet short-term obligations). Risk-return tradeoff is fundamental - higher returns generally come with higher risk. The optimal financial strategy maximizes value while managing risk appropriately.`,
        ...
        questions: [
          ...
          { question: 'An investment of Rs 10,000 is made today at 10% annual interest. What is the future value after 3 years?', options: ['Rs 13,000', 'Rs 13,310', 'Rs 13,100', 'Rs 10,300'], correctAnswer: 1, explanation: 'FV = PV x (1+r)^n = 10,000 x (1.10)^3 = 10,000 x 1.331 = Rs 13,310.' },
          { question: 'A company expects to receive Rs 1,21,000 after 2 years. If the discount rate is 10%, what is the present value?', options: ['Rs 1,00,000', 'Rs 1,10,000', 'Rs 1,21,000', 'Rs 90,000'], correctAnswer: 0, explanation: 'PV = FV / (1+r)^n = 1,21,000 / (1.10)^2 = 1,21,000 / 1.21 = Rs 1,00,000.' },
          { question: 'A company pays a dividend of Rs 5 per share (D1), the share price is Rs 100 (P0), and dividends grow at 6% (g). What is the cost of equity using the Dividend Discount Model?', options: ['5%', '6%', '11%', '10%'], correctAnswer: 2, explanation: 'Ke = D1/P0 + g = 5/100 + 0.06 = 0.05 + 0.06 = 0.11 = 11%.' },
        ],
      },
      {
...
Weighted Average Cost of Capital (WACC) = (Weight of Equity x Cost of Equity) + (Weight of Debt x Cost of Debt). WACC is used as the discount rate for NPV calculations. The optimal capital structure minimizes WACC and maximizes firm value.`,
        ...
        questions: [
          ...
          { question: 'A project requires an initial investment of Rs 50,000 and generates cash inflows of Rs 20,000 per year for 3 years. At a 10% discount rate (PV factors: Year 1=0.909, Year 2=0.826, Year 3=0.751), what is the NPV?', options: ['Rs 10,000', 'Rs -280', 'Rs 720', 'Rs -720'], correctAnswer: 1, explanation: 'PV of inflows = (20,000 x 0.909) + (20,000 x 0.826) + (20,000 x 0.751) = 18,180 + 16,520 + 15,020 = Rs 49,720. NPV = 49,720 - 50,000 = Rs -280. The project has a negative NPV and should be rejected.' },
          { question: 'A company has equity of Rs 60 lakhs (cost 14%) and debt of Rs 40 lakhs (pre-tax cost 10%, tax rate 30%). What is the WACC?', options: ['12%', '11.2%', '10.4%', '8.4%'], correctAnswer: 1, explanation: 'After-tax cost of debt = 10% x (1 - 0.30) = 7%. WACC = (60/100 x 14%) + (40/100 x 7%) = 8.4% + 2.8% = 11.2%.' },
          { question: 'Risk-free rate is 7%, market return is 15%, and a stock has beta of 1.5. Using CAPM, what is the cost of equity?', options: ['15%', '19%', '22%', '12%'], correctAnswer: 1, explanation: 'CAPM: Ke = Rf + Beta x (Rm - Rf) = 7% + 1.5 x (15% - 7%) = 7% + 1.5 x 8% = 7% + 12% = 19%.' },
        ],
      },
      {
...
Cash management involves maintaining optimal cash balances. Models include Baumol Model (treating cash as inventory, optimizing transaction costs vs opportunity costs) and Miller-Orr Model (setting control limits for cash fluctuations). Cash budget is the key tool for forecasting cash needs.`,
        ...
        questions: [
          ...
          { question: 'A company has current assets of Rs 12,00,000 and current liabilities of Rs 8,00,000. What is the current ratio and net working capital?', options: ['Current ratio 1.5:1, NWC Rs 4,00,000', 'Current ratio 0.67:1, NWC Rs -4,00,000', 'Current ratio 1.5:1, NWC Rs 12,00,000', 'Current ratio 2:1, NWC Rs 4,00,000'], correctAnswer: 0, explanation: 'Current ratio = Current Assets / Current Liabilities = 12,00,000 / 8,00,000 = 1.5:1. NWC = CA - CL = 12,00,000 - 8,00,000 = Rs 4,00,000.' },
          { question: 'A firm has an inventory conversion period of 60 days, receivable collection period of 40 days, and payable deferral period of 30 days. What is the operating cycle?', options: ['130 days', '100 days', '70 days', '30 days'], correctAnswer: 2, explanation: 'Operating Cycle = Inventory Conversion Period + Receivable Collection Period - Payable Deferral Period = 60 + 40 - 30 = 70 days.' },
          { question: 'A company has annual sales of Rs 36,00,000 and average debtors of Rs 3,00,000. What is the average collection period?', options: ['12 days', '30 days', 'Rs 3,00,000', '120 days'], correctAnswer: 1, explanation: 'Debtors Turnover = Sales / Average Debtors = 36,00,000 / 3,00,000 = 12 times. Average Collection Period = 365 / 12 = approximately 30 days.' },
        ],
      },
      {
...
The BCG Matrix classifies business units as Stars (high market share, high growth), Cash Cows (high share, low growth), Question Marks (low share, high growth), and Dogs (low share, low growth). This helps in resource allocation across a diversified portfolio.`,
        ...
        questions: [
          ...
          { question: 'A company with 50% market share operates in an industry growing at 2% per year. In the BCG Matrix, this business unit would be classified as:', options: ['Star', 'Cash Cow', 'Question Mark', 'Dog'], correctAnswer: 1, explanation: 'High market share (50%) in a low-growth industry (2%) classifies the unit as a Cash Cow. Cash Cows generate more cash than they need and fund other business units.' },
          { question: 'A company that manufactures steel acquires an iron ore mining company (its raw material supplier). This is an example of which corporate strategy?', options: ['Forward integration', 'Backward integration', 'Horizontal integration', 'Conglomerate diversification'], correctAnswer: 1, explanation: 'Acquiring a supplier (iron ore mining) is backward integration - moving backward in the supply chain to gain control over raw material sources.' },
          { question: 'In Porter\'s Five Forces analysis, an industry where customers can easily switch to competitor products at no cost indicates:', options: ['Low threat of substitutes', 'High bargaining power of buyers', 'Low rivalry among competitors', 'High barriers to entry'], correctAnswer: 1, explanation: 'When customers face low switching costs and can easily move to competitors, they have high bargaining power. This puts pressure on companies to offer better prices or quality.' },
        ],
      },
    ],
  },
